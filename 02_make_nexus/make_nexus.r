...
make_nexus_dict(raw_data, analysis = "a", granularity = "f", var_filter = 0.5, entry_filter = 0.5, k = 5)
make_nexus_dict(raw_data, analysis = "a", granularity = "f", var_filter = 0.35, entry_filter = 0.3, k = 1)
...
make_nexus_dict(raw_data, analysis = "b", granularity = "f", var_filter = 0.5, entry_filter = 0.5, k = 4)
make_nexus_dict(raw_data, analysis = "b", granularity = "f", var_filter = 0.35, entry_filter = 0.3, k = 1)
